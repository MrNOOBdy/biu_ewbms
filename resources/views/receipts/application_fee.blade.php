...
<body>
    <div class="receipt-container" id="receipt-{{ $payment->customer_id }}">
        <div class="print-buttons">
            <button class="print-button" onclick="printApplicationReceipt('{{ $payment->customer_id }}')">
                <i class="fas fa-print"></i> Print Receipt
            </button>
            <button class="download-button" onclick="downloadApplicationReceipt('{{ $payment->customer_id }}')">
        ...
        <div class="receipt-details">
            <table>
                ...
                <tr>
                    ...
                    <td>{{ ucfirst($payment->conn_pay_status) }}</td>
                </tr>
                <tr>
                    <td>Payment Date:</td>
