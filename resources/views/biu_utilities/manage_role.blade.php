...
<div class="table-header">
    ...
    <div class="header-controls">
        @if($userRole->permissions->contains('slug', 'add-new-role'))
        ...
        <table class="uni-table">
            <thead>
                <tr>
                    <th>ID</th>
                    <th>Role Name</th>
                    @if($userRole->permissions->contains('slug', 'manage-role-permissions') || 
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            ...
                            @if($userRole->permissions->contains('slug', 'edit-role'))
