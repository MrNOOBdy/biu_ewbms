...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 28, 2025 at 11:00 PM
...
('sms_throttle_+639207855266', 'b:1;', 1743047652),
('sms_throttle_+639954179164', 'b:1;', 1743128792);
...
(47, 'B01-01', 1050.00, 1050.00, 'paid', '2025-03-28 06:52:31', '2025-03-28 06:54:15'),
(48, 'B01-01', 1050.00, 1050.00, 'paid', '2025-03-28 06:58:42', '2025-03-28 06:59:01'),
(49, 'B01-01', 1050.00, 1050.00, 'paid', '2025-03-28 07:27:34', '2025-03-28 07:28:33');
...
INSERT INTO `consumer_bill_pay` (`id`, `consread_id`, `total_amount`, `bill_tendered_amount`, `bill_status`, `created_at`, `updated_at`, `penalty_amount`) VALUES
(4, 15, 190.00, 190.00, 'paid', '2025-03-28 07:38:09', '2025-03-28 13:47:29', 20.00);
...
(15, 'B01-01', 4, '2025-03-25', '2025-04-01', 150.00, 170.00, 10.00, 'John Doe', '2025-03-28 07:26:13', '2025-03-28 07:26:13');
...
(4, '2025-03-01', '2025-04-01', '2025-03-25', '2025-03-31', 'Open', '2025-01-23 18:18:01', '2025-03-27 23:48:54'),
(5, '2025-04-01', '2025-05-01', '2025-04-25', '2025-04-30', 'Close', '2025-01-23 18:24:53', '2025-03-27 23:48:54'),
...
(63, '2025_03_27_135136_penalty_amount_for_consumer_bill_pay', 50);
...
(52, 'Access Meter Readers Block', 'access-meter-readers-block', 'Can access meter readers block management', '2025-03-28 13:55:55', '2025-03-28 13:55:55');
...
(3, 3, NULL, NULL),
(3, 4, NULL, NULL),
(3, 5, '2025-03-28 13:57:52', '2025-03-28 13:57:52'),
(3, 6, NULL, NULL),
(3, 8, NULL, NULL),
(3, 9, '2025-03-28 07:01:16', '2025-03-28 07:01:16'),
(3, 10, NULL, NULL),
(3, 11, NULL, NULL),
(3, 12, NULL, NULL),
(3, 13, NULL, NULL),
...
(3, 50, NULL, NULL),
(3, 51, NULL, NULL),
(3, 52, '2025-03-28 14:27:42', '2025-03-28 14:27:42'),
(34, 5, NULL, NULL),
(34, 6, NULL, NULL),
(34, 8, NULL, NULL),
(34, 9, NULL, NULL),
...
(19, 'B01-01', 700.00, 700.00, 'paid', '2025-03-28 06:54:33', '2025-03-28 06:54:49'),
(22, 'B01-01', 0.00, 700.00, 'unpaid', '2025-03-28 07:37:25', '2025-03-28 07:37:25');
...
(1, 'Ejay Luis', 'Rebucas', 'chillZY', 'luisej258@gmail.com', '$2y$12$fCX6Kv14r9B9P9q2.g41ces1HMHp0fbPZQH4oJrIh2my1AkMj0imK', '09275824005', 'Administrator', 'activate', 'IDC39FaoRj7Zw6zKGSV93OP18gGiYyEYFBCBF8VndEVQf8xwQpyn1iHuOyPA', '2025-01-14 00:16:33', '2025-03-25 00:24:21'),
...
(63, 1, 'B01-01', 'Ejay Luis', 'Corro', 'Rebucas', 'Purok 6, Poblacion', '09275824005', 'Residential', 'Inactive', 0.00, 700.00, '2025-03-28 07:27:34', '2025-03-28 07:37:26');
...
--
ALTER TABLE `conn_payment`
  MODIFY `connpay_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `consumer_reading`
  MODIFY `consread_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `coverage_date`
--
ALTER TABLE `coverage_date`
  MODIFY `covdate_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `permissions`
  MODIFY `permission_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=53;
...
--
ALTER TABLE `service_fee_payment`
  MODIFY `service_pay_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `water_consumers`
  MODIFY `watercon_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;
